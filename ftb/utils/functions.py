...
from ftb import aiohttpsession as aiosession
from ftb.utils.dbfunctions import start_restart_stage
from ftb.utils.http import get, post


async def restart(m: Message):
    if m:
        await start_restart_stage(m.chat.id, m.message_id)
    execvp(executable, [executable, "-m", "ftb"])
