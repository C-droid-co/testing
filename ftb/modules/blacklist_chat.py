...
from ftb.utils.dbfunctions import blacklist_chat, blacklisted_chats, whitelist_chat
...
@app.on_message(filters.command("blacklist_chat") & SUDOERS & ~filters.edited)
@capture_err
...
@app.on_message(filters.command("whitelist_chat") & SUDOERS & ~filters.edited)
@capture_err
...
@app.on_message(filters.command("blacklisted_chats") & SUDOERS & ~filters.edited)
@capture_err
