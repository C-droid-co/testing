...
from ftb import BOT_ID

# from ftb import OWNER_ID as SUDO_USERS
from ftb.services.pyrogram import pbot
from ftb.services.sql import forceSubscribe_sql as sql
